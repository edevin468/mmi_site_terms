...
# -*- coding: utf-8 -*-
"""
Created on Mon Jul 27 11:35:30 2020
...
slope1, intercept1, r_value1, p_value1, std_err1 = stats.linregress(bin_centers[:-3],bin_means[:-3])
slope2, intercept2, r_value2, p_value2, std_err2 = stats.linregress(bin_centers[-4:-1],bin_means[-4:-1])
x1 = np.linspace(0,1000, 500)
y1 = slope1*x1 + intercept1
x2 = np.linspace(1000,1450,500)
...
print('\n  ------------------------------------------\n  Linear model of VS30 and Site Term:\n',
      ' ------------------------------------------\n',
      '\n\nF = ',slope1,'* VS30 +',intercept1 ,'for VS30 <= 1000',
      '\nF = ',slope2,'* VS30 +',intercept2 ,'for VS30 > 1000',
      '\n\nR-Squared = ', r_value1**2, 'for VS30 <= 1000',
      '\nR-Squared = ', r_value2**2, 'for VS30 > 1000')
