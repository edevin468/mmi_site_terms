...
RESID_FILE = '/Users/emmadevin/Work/USGS Work/USGS PLUM/Data/SoCal_filtered.csv'
OUTPUT_DIR = '/Users/emmadevin/Work/USGS Work/USGS PLUM/Data/LME_SoCal_filtered'

if not os.path.exists(OUTPUT_DIR):
    os.makedirs(OUTPUT_DIR)

df = pd.read_csv(RESID_FILE)
imt_cols = [col for col in df.columns if 'TotalResidual' in col]
