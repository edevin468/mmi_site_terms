...
df = pd.read_csv('/Users/emmadevin/Work/USGS Summer 2020/USGS PLUM/EEW Example/contMMI35.csv')
...
df2.to_csv('/Users/emmadevin/Work/USGS Summer 2020/USGS PLUM/EEW Example/oct35.csv')
